...
import { getIslanderPoints } from '../store/globalData.js'
...
const islanderId = computed(() => props.islander.id ?? String(props.islander.id))
...
const points = computed(() => getIslanderPoints(islanderId.value))
const elim = computed(() => props.islander.status === 'dumped')
